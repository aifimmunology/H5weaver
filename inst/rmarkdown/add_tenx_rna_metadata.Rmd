...
if(!file.exists(in_mol)) {
  stm(paste0("ERROR: Cannot find IN Mol Info H5 file:", in_h5))
  stop()
}
if(!file.exists(in_sum)) {
  stm(paste0("ERROR: Cannot find IN Metrics Summary file:", in_h5))
  stop()
}
if(!file.exists(in_h5)) {
  stm(paste0("ERROR: Cannot find IN SampleSheet file:", in_h5))
  stop()
}
```
